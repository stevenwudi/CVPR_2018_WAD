...
if __name__ == '__main__':
    # data_dir = '/home/public/CITYSCAPE/gtFine'
    # prepare_cityscape_training(data_dir)
    data_dir = '/home/stevenwudi/PycharmProjects/DenseNetSeg/logs/crop_size_1024_out_channels_num_(1, 2, 4, 8, 16)_ppl_out_channels_num_(32, 64, 128, 256)_dilation_(1, 2, 4, 8)___test/leftImg8bit/test'
    prepare_cityscape_submission(data_dir)
